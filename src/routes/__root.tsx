...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Naaga Sumukh B S - AI/ML Engineer | Bengaluru" },
      { name: "twitter:description", content: "Portfolio of Naaga Sumukh B S - AI/ML engineer building intelligent systems. NMIT Bengaluru, 2023–2027." },
