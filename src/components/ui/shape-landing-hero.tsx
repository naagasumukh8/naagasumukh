      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm text-white/85 tracking-wide">{badge}</span>
          </motion.div>
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="text-base sm:text-lg md:text-xl text-white/75 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
