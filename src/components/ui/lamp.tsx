    ...
    >
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center">
        <motion.div
          ...
          style={{
            backgroundImage:
              "conic-gradient(var(--conic-position, from 70deg at center top), var(--tw-gradient-stops))",
          }}
        ...
        <motion.div
          ...
          style={{
            backgroundImage:
              "conic-gradient(var(--conic-position, from 290deg at center top), var(--tw-gradient-stops))",
          }}
