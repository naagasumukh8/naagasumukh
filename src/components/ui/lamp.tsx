...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex w-full flex-col items-center justify-center overflow-hidden bg-transparent z-0",
        className
      )}
    >
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center">
        <motion.div
          ...
          style={{ backgroundImage: "conic-gradient(var(--conic-position, from 70deg at center top), var(--tw-gradient-stops))" }}
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, width: "30rem" }}
          transition={{ delay: 0.3, duration: 0.8, ease: "easeInOut" }}
          style={{ backgroundImage: "conic-gradient(var(--conic-position, from 290deg at center top), var(--tw-gradient-stops))" }}
